                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <button type="button" class="btn btn-primary" onclick="window.print();" class="noPrint" style="color:gold">PRINT  REPORT</button>
...
<center>                                    <img src="<?php echo base_url();?>assets/images/hrinv.png" alt="DRI" class="DRI-logo" style="width:200px;"/>
                                ...
                                <center><h3><b><u>ASSETS ASSIGNED TO EMPLOYEES</u></b></h3></center>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1"><i class="fa fa-map-o"></i> Add Logistic Support </h4>
                                           ...
                                           <div class="row">
                                            <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <select class="select2 form-control custom-select assetsstock" data-placeholder="Choose asset To Assign" tabindex="1" name="logid" style="width:100%" required>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <select class="select2 form-control custom-select" data-placeholder="Select Employee To Assign" tabindex="1" name="assignid" id="assignval" style="width: 100%" required>
                                                  <option value="">Select here</option>
                                            ...
                                            <div class="col-md-6">                                        
                                            <div class="form-group">
                                                <label class="control-label">Date Asset Assigned </label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Model No OR S/NO</label>
                                                <textarea class="form-control col-md-8" name="remarks" id="message-text1" required></textarea>
                                    ...
                                    <div class="modal-body">
                                       ...
                                       <div class="col-md-6">
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label"> Date Asset Returned</label>
