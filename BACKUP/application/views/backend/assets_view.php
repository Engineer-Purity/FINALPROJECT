            ...
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a data-toggle="modal" data-target="#expenmodel" class="text-white"  data-whatever="@getbootstrap"><i class="" aria-hidden="true"></i>  Add Expenditure</a></button>
                                    ...
                                    <div class="modal-body">
                                           <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="config" id="message-text1" required minlength="2" rows="4"></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="pqty" value=""
                                                 ...
                                                 <H5 style="color:red"><b><u>N/B :If Theres no Model Or S/No Input NA</u></b></H5>
...
<!--
                          ...
                          <!-- sample modal content -->
                          <div class="modal fade" id="expenmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1">Add Expenditure </h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    <form method="post" action="Add_Assets" id="btnSubmit" enctype="multipart/form-data">
                                    <div class="modal-body">
                                           <div class="row">
                                            ...
                                            <div class="form-group">
                                               <label class="control-label">CATEGORY </label>
                                                <select name="catid" type="hidden" value="" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?>class="select2 form-control custom-select" style="width: 100%" readonly>
                                                    <option>NO CATEGORY</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label"></label>
                                                <input  type="hidden" name="brand" value="NA" class="form-control" id="recipient-name1">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label"></label>
                                                <input type="hidden" name="model" value="NA" class="form-control" id="recipient-name1">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">MPESA/BANK CODE</label>
                                                <input type="text" name="code" value="" class="form-control" id="recipient-name1 ">
                                            </div>                                                   
                                               </div>
                                               <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">ABOUT EXPENDITURE </label>
                                                <textarea class="form-control" name="config" id="message-text1" required minlength="2" rows="4"></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label"></label>
                                                <input type="hidden" name="pqty" value="NA"
                                                 class="form-control" id="recipient-name1">
