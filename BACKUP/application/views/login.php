...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url(); ?>assets/images/background/hrbbg.jpg);">
        ...
        <div class="login-box card">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                    <a href="javascript:void(0)" class="text-center db"><br/><img src="<?php echo base_url(); ?>assets/images/logo.jpg" width="175px" alt="Home" /></a>
                    <center><b><u><h1 style="color:blue;">HILIFE LTD HR SYSTEM</h1></u></b></center>
                    <center><b><u><h1 style="color:gold;">LOGIN</h1></u></b></center>                                       
                 ...
                 <div class="form-check">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-success btn-login btn-block text-uppercase waves-effect waves-light" type="submit">Admin Log In</button>
        ...
        <center><h5> <b> <u>2022  Hilife HR System</u> </b> </h5></center>
    </section>
    <!-- ============================================================== -->
    <!-- End Wrapper -->
    <!-- ============================================================== -->
