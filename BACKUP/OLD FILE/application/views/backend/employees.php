                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <button type="button" class="btn btn-primary" onclick="window.print();" class="noPrint" style="color:gold">PRINT EMPLOYEE LIST</button>
...
<center>                                    <img src="<?php echo base_url();?>assets/images/hrinv.png" alt="DRI" class="DRI-logo" style="width:200px;"/>
                                ...
                                <center><h3><b><u>HILIFE CAPITAL LIMITED LIST OF ALL EMPLOYEES</u></b></h3></center>
                                           ...
                                           <?php foreach($employee as $value): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <!-- <a onclick="return confirm('Are you sure to delete this data?')" href="<?php echo base_url();?>employee/DeleteEdu/<?php echo $value->id;?>" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash-o"></i></a> -->
