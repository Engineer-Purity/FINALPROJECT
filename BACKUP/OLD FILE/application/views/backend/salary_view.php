      ...
      <div class="col-12">
        <div class="card card-outline-info">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-primary" onclick="window.print();" class="noPrint" style="color:gold">PRINT</button>
        ...
        <div class="modal-content ">
          ...
          <form method="post" action="pay_salary_add_record" id="generatePayrollForm" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="col-md-6">                                    
              <div class="form-group row">
                <label class="control-label text-left col-md-5">NET PAY
                </label>
                <div class="col-md-7">
              ...
              <div class="form-group row" id="diduction">
                ...
                <div class="col-md-7">
                <input type="text" name="diduction" class="form-control diduction" id=""  readonly>
              </div>                                      
              </div>    
      ...
      $(document).ready(function () {
        ...
        $(document).on('click', ".salaryGenerateModal", function (e) {
          ...
          $.ajax({
            ...
            $('#generatePayrollForm').find('[name="houserent"]').val(response.nhif).attr('readonly', true).end();
