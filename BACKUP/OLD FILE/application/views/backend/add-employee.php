                            ...
                            <div class="card-body">
                                ...
                                <form class="row" method="post" action="Save" enctype="multipart/form-data">
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <input type="text" name="fname" class="form-control form-control-line" placeholder="Your first name" minlength="2"  value="HILIFE"required > 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
                                        <label>Last Name </label>
                                        <input type="text" id="" name="lname" class="form-control form-control-line" value="LIMITED" placeholder="Your last name" minlength="2" required> 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <input type="text" name="nid" class="form-control" value="" placeholder="" maxlength="10" required> 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
                                        <label>Contact Number </label>
                                        <input type="text" name="contact" class="form-control" value="+254" placeholder="+254*********" minlength="13" maxlength="13" required> 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
