                                    ...
                                    <table class='table table-condensed borderless' style='border-left: 1px solid #ececec;'>
                                        ...
                                        <tfoot class='tfoot-light'>
                                            <tr>
                                                ...
                                                <th class='text-right'>". $addition[0]->basic - ($addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance); echo"Ksh</th>
                                                <th class='text-right'>".$addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance; echo"Ksh</th>
                                            </tr>
