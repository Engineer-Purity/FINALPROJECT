                                ...
                                <div class='col-md-12'>
                                    <table class='table table-condensed borderless payslip_info'>
                                        ...
                                        <tr>
                                            ...
                                            . $addition[0]->daysworked; echo

                                            // .$netpay = ((($addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance) + ($addition[0]->basic - ($addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance)))*30)/$addition[0]->basic;
                                            // .((($addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance)+($addition[0]->basic - ($addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance)))*30)/($addition[0]->basic+($addition[0]->basic - ($addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance))+($addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance));
                                            "</td>";
                                ...
                                <div class='col-md-12'>
                                    <table class='table table-condensed borderless' style='border-left: 1px solid #ececec;'>
                                        ...
                                        <tbody style='border: 1px solid #ececec;'>
                                            <tr>
                                                <td>Basic Salary</td>
                                                <td class='text-right'>". $addition[0]->basic; echo"Ksh</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class='text-right'>". $addition[0]->medical; echo "Ksh</td>
                                            </tr>
                                            <tr>
                                                <td>NHIF</td>
                                                  <td class='text-right'>  </td>

                                                <td class='text-right'>".$addition[0]->house_rent; echo "Ksh</td>
                                            </tr>
                                            <tr>
                                                <td>PAYE</td>
                                                                                                <td class='text-right'>  </td>

                                                <td class='text-right'>".$addition[0]->conveyance; echo "Ksh</td>
                                            </tr>
                                        ...
                                        <tfoot class='tfoot-light'>
                                            <tr>
                                                ...
                                                <th class='text-right'>". $total_add = $addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance; echo"Ksh</th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                                <th class='text-right'>Net Pay</th>
                                                <th class='text-right'>". $total_add =  $addition[0]->basic -  ($addition[0]->medical + $addition[0]->house_rent + $addition[0]->conveyance); echo "Ksh</th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
