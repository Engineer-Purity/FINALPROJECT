                                ...
                                <div class="col-md-12">
                                    <table class="table table-condensed borderless" style="border-left: 1px solid #ececec;">
                                        ...
                                        <tbody style="border: 1px solid #ececec;">
                                            <tr>
                                                <td>Gross Salary</td>
                                                <td class="text-right"><?php echo $addition[0]->basic; ?> Ksh</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>NHIF</td>
                                                <td class="text-right"> <?php echo $addition[0]->medical; ?>  Ksh</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>NSSF</td>
                                                <td class="text-right"><?php echo $addition[0]->house_rent; ?>  Ksh</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>PAYE(TAX)</td>
                                                <td class="text-right"><?php echo $addition[0]->conveyance; ?>  Ksh</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <!-- <tr>
                                                <td>Bonus</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <?php
                                                        if($a > 0) { echo round($a,2).' Ksh'; }
                                                    ?>
                                                </td> -->
                                                <td class="text-right">
                                                    <?php
                                                        if($d > 0) { echo round($d,2).' Ksh'; }
                                                    ?>        
                                                </td>
                                                <td class="text-right"> </td>
                                            </tr>
                                            <!--<tr>
                                                ...
                                                <td class="text-right"> <?php
                                                        /*if($d > 0) { echo round($d,2).' Ksh'; }*/
                                                        echo $salary_info->diduction .'Ksh';
                                                    ?> </td>
                                        ...
                                        <tfoot class="tfoot-light">
                                            <tr>
                                                <th>Total</th>
                                                <th class="text-right"><?php $total_add = $salary_info->basic + $salary_info->medical + $salary_info->house_rent + $salary_info->bonus+$a; echo round($total_add,2); ?> Ksh</th>
                                                <!-- <th class="text-right"><?php $total_did = $salary_info->loan+$salary_info->diduction; echo round($total_did,2); ?> Ksh</th> -->
                                            </tr>
                                            <tr>
                                                <th></th>
                                                <th class="text-right">Net Pay</th>
                                                <th class="text-right"><?php echo $salary_info->total_pay/*round($total_add - $total_did,2)*/; ?> Ksh</th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Basic Salary</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->basic;?> Ksh</td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Madical</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->medical;?> Ksh </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>House Rent</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->house_rent;?> Ksh </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Conveyance</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->conveyance;?> Ksh </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Loan</td>
                                                    <td class="text-right"> </td>
                                                    <td class="text-right"><?php echo $salary_info->loan;?>  Ksh</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <th>Total</th>
                                                    <th class="text-right"><?php echo $salaryvaluebyid->total;?> Ksh</th>
                                                    <th class="text-right"><?php echo $salary_info->diduction;?>  Ksh</th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        <h3><b>Total :</b>  <?php echo $salary_info->total_pay;?> Ksh</h3>
                                    </div>
        ...
        $(".SalarylistModal").click(function (e) {
            ...
            $.ajax({
               ...
               /* $('#salaryform').find('[name="typeid"]').val(response.salaryvalue.type_id).end();*/
                ...
                $('#salaryform').find('[name="daysworked"]').val(response.salaryvalue.daysworked).end();
