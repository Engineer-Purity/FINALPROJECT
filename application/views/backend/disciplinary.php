                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <button type="button" class="btn btn-primary" onclick="window.print();" class="noPrint" style="color:gold">PRINT DISCIPLINARY REPORT</button>
                                    ...
                                    <center><h3><b><u>HILIFE LIMITED EMPLOYEE DISCIPLINARY REPORT</u></b></h3></center>
                                    ...
                                    <table  class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <?php if($this->session->userdata('user_type')=='ADMIN'){ 
                                            ...
                                            <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ 
                                                 ...
                                                 foreach($desciplinary as $value): ?>
                                                <tr>
                                                <td ><?php echo $basicinfo->first_name.' '.$value->last_name; ?></td>
                                                <td ><?php echo $value->em_code; ?></td>
                                                <td ><?php echo $value->title; ?></td>
                                                <td><?php echo  $value->description ?> </td>
                                                <td><button class="btn btn-sm btn-success"><?php echo $value->action; ?></button></td>
