                            ...
                            <div class="card-body">
                                <form method="post" action="" id="salaryform" class="form-material row">
                                    <div class="form-group col-md-3">
                                        <select class="form-control custom-select"  tabindex="1" name="emid" id="emid" style="margin-top: 23px" required  <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?>>
                                         ...
                                         <?php endforeach; ?>
                                                    <?php }else{?>
                                                      <option value="<?php echo $id = $this->session->userdata('user_login_id');
            $basicinfo = $this->employee_model->GetBasic($id); ?>">
            <?php echo $basicinfo->first_name ?>
            <?php echo $basicinfo->last_name ?></option>
                                    ...
                                    <div class="form-group col-md-4">
                                      ...
                                      <div class="form-group col-md-3">
                                      <button style="float:left;margin-top:23px" type="submit" id="BtnSubmit" 1class="btn btn-primary">Submit</button>          
                                       </div>
                                </form>
                            </div>
                        </div>
